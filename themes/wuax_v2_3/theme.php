<?php
 ...
 echo"<br/></center></div></div>
     <div id='nybox_bot'></div>
          <div id='nybox1_head'></div>
          <div id='nybox1_mid'> <div id='omwuax'><center>";
 }
...
<div id="mellom"></div>
<div id="hot_head"></div>
<div id="reglogtop"><a href="forum.php"><img src="themes/<?=THEME?>/images/wuaxlog.png" border="0"/></a></div>
<div id="userinfo"></div>
<div id="reg"><a href="forum.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('regg','','themes/<?=THEME?>/images/regg_light.png',1)"><img src="themes/<?=THEME?>/images/regg.png" name="regg" width="119" height="25" border="0" id="regggg" /></a></div>
<div id="log"><a href="forum.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('logginn','','themes/<?=THEME?>/images/logginn_light.png',1)"><img src="themes/<?=THEME?>/images/logginn.png" name="logginn" width="86" height="25" border="0" id="logginn" /></a></div>
...
<div id="mskill"></div>
     ...
     <div id="aboxmid"></div>
     <div id="nboxhead"></div>
          <div id="nboxmid"><a href="#"><img src="themes/<?=THEME?>/images/anrop.png" border="0"></a></div>
          <div id="anboxhead"></div>
          <div id="anboxmid"></div>
             
     <div id="nybox_head"></div>
     <div id="nybox_mid">  <div id="omwuax"><center><br/>
   <?php } 
